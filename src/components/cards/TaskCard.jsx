...
const TaskCard = ({ title, description, priority, status, progress, createdAt, dueDate, assignedTo, attachmentCount, completedTodoCount, todoChecklist, onClick }) => {
    ...
    return (
        <div className='bg-white rounded-xl py-4 shadow-md shadow-gray-100 border flex flex-col justify-between
         border-gray-200/50  cursor-pointer' onClick={onClick} >
            <div className="flex gap-3 items-end px-4 ">
                ...
                <div className={`text-[11px] font-medium ${getPriorityTagColor()} px-4 py-0.5 rounded `}>{priority}</div>
            </div>
            ...
            <div className="px-4">
                ...
                <div className="flex items-center justify-between mt-3  ">
                    ...
                    {
                        attachmentCount > 0 && (
                            <div className="flex items-center gap-2 bg-blue-50 py-1.5 rounded-lg px-2.5">
